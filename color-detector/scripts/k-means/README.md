...
## Overview
This folder contains the implementation of the **K-Means** algorithm for bone color detection and quantitative analysis.  
...
## Contents
- `kmeans.ipynb` — Jupyter Notebook with the full implementation.
